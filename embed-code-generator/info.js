...
function renderEmbed(url, imageinfo) {
  chrome.tabs.query({'active': true}, function(tabs) {
    ...
    var img_url = url;
    var img_height = imageinfo.height;
    var img_width = imageinfo.width;
    var innerText = "<p><a href='"+ site_url +"'><img src='"+ img_url +"' width='"+ img_width +"' height='" + img_height +"' border='0' /></a></p>";
    embed.append(innerText);
  });
};
